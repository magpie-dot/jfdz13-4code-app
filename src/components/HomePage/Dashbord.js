        ...
        <div className={classes.root}>
            <Grid container spacing={3}>
                <Grid item xs>
                    <Paper className={classes.paper1}>
                        <h2>Ostatnio trafili do naszej Fundacji. Pomóż im znaleźć ciepły dom!</h2>
                        <Carusel/>
                    </Paper>
                </Grid>
                <Grid item xs>
                    <Paper className={classes.paper2}>
                        ...
                        <div className={style.description}>Adoptuj, nie kupuj! – to hasło słyszymy coraz częściej,
                            ...
                            problemów współczesnego świata. Tak jak bycie eko.
                        </div>
                        <h3>
                            Rozpoczynając poszukiwania przyjaciela, można określić kryteria,
            ...
            <Grid item xs>
                <Paper className={classes.paper4}>
                    {props.animals.map(({id, data, descriptions}) => <AnimalCard key={id} data={data}
